...
//     var stats = [];
//     stats.push({job_type: "Household Chore", num_of_occurrences: 1});
//     stats.push({job_type: "Yard Work", num_of_occurrences: 2});
//     stats.push({job_type: "Car Wash", num_of_occurrences: 3});
...
//     var job4 = new Job();
//     var dEmployer = new User();
//     job4.job_title = "Household Chore";
...
//     var stats = [];
//     stats.push({job_type: "Car Wash", num_of_occurrences: 2});
//     stats.push({job_type: "Yard Work", num_of_occurrences: 3});
//     stats.push({job_type: "Household Chore", num_of_occurrences: 1});
...
//       res.body.should.not.have.property('errorMessage');
//       res.body[0].should.have.property('job_title').eql("Yard Work");
//       res.body[1].should.have.property('job_title').eql("Yard Work");
//       res.body[2].should.have.property('job_title').eql("Car Wash");
//       res.body[3].should.have.property('job_title').eql("Household Chore");
//       done();
//     });
//   });
...
//       res.body.should.include("Car Wash");
